            ...
            <div className="col-lg-6 col-md-12" id="about">
              ...
              <div className="paragraph py-4 w-75">
                <p className="para">
                  ...
                  always been interested in coding but never knew where to
                  start, until this year. I have a lot to learn and I am excited
                ...
                <ul>
                  ...
                  <li className="hobb">
                    Drinking tons of coffee <i className="fas fa-mug-hot"></i>
                  </li>
                  <li className="hobb">
                    Taking my dog, Baxter, on longs walks{" "}
